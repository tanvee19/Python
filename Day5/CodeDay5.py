# -*- coding: utf-8 -*-
"""
Created on Sat May 11 09:04:15 2019
...
import re
input1 = input("Enter emails : ").split()
for each in input1:
    if(re.match(r'^[a-zA-Z]{1}[a-zA-Z0-9\.\_\-]*@[a-zA-Z]+\.[a-zA-Z]{2,4}$',each)):
        print("Valid")
    else:
        print("not valid")
...
if(re.match(r'^[456]{1}\d{3}[\-]*\d{4}[\-]*\d{4}[\-]*\d{4}$',input1)):
    print("Valid")
else:
    print("not valid")
